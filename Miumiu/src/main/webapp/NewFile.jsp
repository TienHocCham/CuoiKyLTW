...
<body>
	...
	<form action"GiangVienServlet" method = "post">
			<div class="khung-menu">
				<div class="buttons">
					...
					<form action="./SearchGVControl" method="post">
				...
				<tbody>
					<c:forEach var="kq" items="${list}">
						<tr>
							...
							<a href="InsertGiangVien?id=${kq.idGiangVien}">Insert</a></td>
						</tr>
					</c:forEach>
